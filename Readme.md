...
| ⏱️ Horizons | 1 hour, 6 hours, 24 hours, and 72 hours ahead |
...
- **Accuracy:** How close are forecasts overall?
- **Bias:** Does the model systematically overpredict or underpredict?
- **Underprediction:** How often does it forecast too low?
- **Peak pressure:** What happens during busy hours?
- **Timing risk:** Which hours or weekdays show the highest error?
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| ⏱️ 1h | Poisson Regression | 0.821 | 0.690 | 44.877 | 0.484 | 0.721 | 1.000 |
